...
const Projects = () => {
  ...
  const fetchRepositories = async () => {
    ...
    try {
      ...
      // Safely attempt to fetch languages; fallback to main language if rate-limited
        ...
        reposData.map(async (repo) => {
          try {
            ...
            if (langRes.ok) {
              ...
              return { ...repo, topLanguages: topLanguages.length ? topLanguages : (repo.language ? [repo.language] : []) };
            }
          } catch {
            // Ignore rate limit on sub-fetch
          }
  ...
  return (
    <section className="section">
      ...
      {/* Repository Grid Layout - 2 Columns */}
